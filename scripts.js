(function($) {
  ...
  var scrollTicker, lightboxAttr, sidebar,
    ...
    topBarTop = '61px',
    headerH = 0,
    mobileInitW = (mfn.mobileInit) ? mfn.mobileInit : 1240;  //  dean
    // mobileInitW = (mfn.mobileInit) ? mfn.mobileInit : 1024;
  ...
  $(document).ready(function() {
    ...
    if (('#Header_creative.scroll').length && window.innerWidth >= 1240) {  //dean
      // if (('#Header_creative.scroll').length && window.innerWidth >= 1024) {
